...
<p>Footnotes are managed from the toolbar. Citations auto-number when inserted.<sup id="citation-fn-0q6s3mokm" data-footnote-citation="fn-69qqry32f" contenteditable="false"><a href="#fn-69qqry32f">[1]</a></sup></p>
<ol data-footnote-list data-protected="true" contenteditable="false"><li id="fn-69qqry32f"><span data-footnote-backlinks><a href="#citation-fn-0q6s3mokm"> [⇧]</a></span><a href="/docs/plugins/footnote">Halka Doc</a></li></ol>
`.trim();
